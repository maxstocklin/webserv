...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/20 21:58:22 by max               #+#    #+#             */
/*   Updated: 2023/09/20 22:13:04 by max              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void CgiHandler::initEnvCgi(HttpRequest& req, const Location& loc)
{
...
void CgiHandler::initEnv(Handler& req, const Location& loc)
{
	int			poz;
